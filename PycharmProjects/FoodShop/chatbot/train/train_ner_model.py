...
corpus = read_file('c:/Users/user/PycharmProjects/FoodShop/chatbot/data/ner_train.txt')
...
model = keras.models.load_model('c:/Users/user/PycharmProjects/FoodShop/chatbot/train/ner_model.h5')
...
# f1 스코어 계산을 위해 사용(sklearn의 함수는 이진분류에서는 사용이 가능하고 다중분류의 경우 average 옵션을 사용할 수 있으나 이 예제에서는 사용이 어려움)
